...
public class PaymentDaoTest {
    public static Payment paidOnTime() {
        return new Payment(1L, adamKowalskiWithoutPaymentList(), LocalDate.of(2025, 2, 28), new BigDecimal("1000"), tuitionFeePaid());
    }

    public static Payment paidOnTimeWithoutStudentDao() {
        return new Payment(1L, adamKowalskiWithoutPaymentList(), LocalDate.of(2025, 2, 28), new BigDecimal("1000"), tuitionFeePaid());
    }
